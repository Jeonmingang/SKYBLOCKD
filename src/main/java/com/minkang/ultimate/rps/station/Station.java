...
public class Station {
    ...
    private int dailyLimitAttempts = 0; // 0 = unlimited
    ...
    public int getDailyLimitAttempts() { return dailyLimitAttempts; }
    public void setDailyLimitAttempts(int n) { this.dailyLimitAttempts = Math.max(0, n); }

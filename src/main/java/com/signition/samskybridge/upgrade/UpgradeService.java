...
String fmt = plugin.getConfig().getString("upgrade.ui.mine.line", "&8- &f{name}: &a{now}% &7→ &b{next}%");
...
String fFmt = plugin.getConfig().getString("upgrade.ui.farm.line", "&8- &f{name}: &a{now}% &7→ &b{next}%");

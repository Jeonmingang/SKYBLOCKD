...
if (this.placedTracker == null) this.placedTracker = new com.signition.samskybridge.place.PlacedTracker();
        pm.registerEvents(new com.signition.samskybridge.listener.BlockXPListener(this, dataStore, levelService, placedTracker), this);
        pm.registerEvents(new com.signition.samskybridge.listener.DropTagListener(this, placedTracker), this);
saveDefaultConfig();

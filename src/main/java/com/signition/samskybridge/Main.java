...
this.levelService = new LevelService(this, dataStore);
        ...
        Bukkit.getScheduler().
        Bukkit.getScheduler().getScheduler().runTaskTimer(this, () -> { try { this.rankingService.rebuildRanks(); } catch (Throwable ignore){} }, getConfig().getLong("rank-refresh-interval-ticks", 1200L), getConfig().getLong("rank-refresh-interval-ticks", 1200L));
Bukkit.getScheduler().runTaskTimer(this, () -> { try { this.rankingService.refreshTabAll(); } catch (Throwable ignore){} }, 20L*10, 20L*10);
        ...
        Bukkit.getScheduler().getScheduler().runTaskTimer(this, () -> rankingService.refreshRanking(), 60L, ticks);

...
public final class Main extends JavaPlugin {
  ...
  private GuiListener guiListener;
    ...
    private RecycleTokenService recycleService;
  ...
  public void onEnable(){
    ...
    getServer().getPluginManager().registerEvents(new com.signition.samskybridge.listener.BlockXPListener(this, dataStore, levelService, placedTracker, recycleService), this);
        getServer().getPluginManager().registerEvents(new com.signition.samskybridge.listener.DropTagListener(this, placedTracker, recycleService), this);
        getServer().getPluginManager().registerEvents(new com.signition.samskybridge.listener.DropTagListener(this, placedTracker, recycleService), this);
        getServer().getPluginManager().registerEvents(new DropTagListener(this, placedTracker, recycleService), this);
    ...
    getServer().getScheduler().runTaskTimer(this, new Runnable(){ public void run(){ rankingService.refresh(); }}, ticks, ticks);
        ...
        if (getConfig().getBoolean("tab_prefix.force", false)){
            ...
            String fmt2 = getConfig().getString("tab_prefix.format_dynamic", getConfig().getString("tab-prefix", "&7[ &a섬 랭킹 <rank>위 &7| &fLv.&b<level> &7]"));

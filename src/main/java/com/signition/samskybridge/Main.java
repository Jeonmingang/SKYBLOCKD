...
this.levelService = new LevelService(this, dataStore);
        ...
        Bukkit.getScheduler().
        Bukkit.getScheduler().runTaskTimer(this, () -> { try { this.rankingService.rebuildRanks(); } catch (Throwable ignore){} }, getConfig().getLong("rank-refresh-interval-ticks", 1200L), getConfig().getLong("rank-refresh-interval-ticks", 1200L));

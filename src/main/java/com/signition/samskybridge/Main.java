...
public class Main extends JavaPlugin {
    ...
    private com.signition.samskybridge.market.MarketService marketService;
    ...
    public void onEnable(){
        ...
        com.signition.samskybridge.feature.FeatureService.initStatic(this, bento);
        ...
        this.marketService = new com.signition.samskybridge.market.MarketService(this);
        ...
        if (getConfig().getBoolean("tablist.enabled", false)){
            this.tablistService = new com.signition.samskybridge.tab.TablistService(this, bento);
    ...
    public com.signition.samskybridge.market.MarketService getMarketService(){ return marketService; }
}
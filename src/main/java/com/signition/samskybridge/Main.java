...
public final class Main extends JavaPlugin {
  ...
  @Override public void onEnable(){ instance=this; saveDefaultConfig(); dataStore=new DataStore(this); levelService=new LevelService(this, dataStore); rankingService=new RankingService(this, dataStore);

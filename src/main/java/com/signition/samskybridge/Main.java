...
public class Main extends JavaPlugin {
    ...
    public void onEnable(){
        ...
        com.signition.samskybridge.chat.IslandChatService islandChat = new com.signition.samskybridge.chat.IslandChatService(this);
        Bukkit.getPluginManager().registerEvents(islandChat, this);
        Bukkit.getPluginManager().registerEvents(new com.signition.samskybridge.chat.IslandChatCommandHook(islandChat), this);

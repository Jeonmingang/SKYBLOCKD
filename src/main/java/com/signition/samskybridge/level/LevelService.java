...
public class LevelService {
  ...
  public void onPlace(BlockPlaceEvent e){
    ...
    private void sendStatus(org.bukkit.entity.Player p, com.signition.samskybridge.data.IslandData is){
        long need = requiredXp(is.getLevel());
        p.sendMessage("§7[§b섬§7] 레벨: §a" + is.getLevel()
                + " §7| XP: §b" + fmtNum(is.getXp()) + "§7/§b" + fmtNum(need));
    }

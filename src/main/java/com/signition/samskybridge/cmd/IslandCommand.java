...
public class IslandCommand implements CommandExecutor, TabCompleter {
  ...
  public boolean onCommand(CommandSender s, Command c, String l, String[] args){
    ...
    if ("리로드".equals(sub) || "설정리로드".equals(sub)){
      if (!p.hasPermission("samskybridge.admin")){ p.sendMessage(Text.color("&c권한이 없습니다.")); return true; }
      plugin.reloadConfig();
      com.signition.samskybridge.util.Configs.ensureDefaults(plugin);

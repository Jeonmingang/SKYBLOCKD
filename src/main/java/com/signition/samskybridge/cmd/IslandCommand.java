...
private void sendLevelWithTemplate(org.bukkit.entity.Player p, com.signition.samskybridge.data.IslandData is) {
    ...
    int mineLevel = com.signition.samskybridge.feature.plugin.getFeatureService().getMineLevel(is.getId());
    int farmLevel = com.signition.samskybridge.feature.plugin.getFeatureService().getFarmLevel(is.getId());
    ...
    for (int i = from; i < to; i++) {
        ...
        if (showUpg) {
            ...
            int haveSum = this.is.getSize() + this.is.getTeamMax()
                        + com.signition.samskybridge.feature.plugin.getFeatureService().getMineLevel(is.getId()) + com.signition.samskybridge.feature.plugin.getFeatureService().getFarmLevel(is.getId());

    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args){
        ...
        switch (args[0]){
            ...
            case "랭킹": {
                ...
                String rh = plugin.getConfig().getString("messages.ranking.header", "&a섬 랭킹 TOP <n>");
                ...
                int i=1; for (java.util.UUID id: top){
                    ...
                    String rl = plugin.getConfig().getString("messages.ranking.line", "&f<rank>. &a<name> &7- &f레벨 <level> &7(경험치 <xp>)");
                ...
                int myRank = ranking.rankOf(p.getUniqueId());
                if (myRank > 0) {
                    String yr = plugin.getConfig().getString("messages.ranking.your-rank", "&a당신의 순위: &f<rank>위");
...
return true;
            ...
            case "레벨": {
                ...
                int lv = levels.getLevel(p.getUniqueId());
                long need = levels.needFor(lv+1);
                long cur = xp;

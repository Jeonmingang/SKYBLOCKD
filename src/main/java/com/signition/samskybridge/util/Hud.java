...
public class Hud {
    ...
    public static void upgraded(org.bukkit.plugin.Plugin plugin, com.signition.samskybridge.data.IslandData is, String what, int before, int after, int step){
        for (org.bukkit.entity.Player t : org.bukkit.Bukkit.getOnlinePlayers()){
            if (is.hasMember(t.getUniqueId())){

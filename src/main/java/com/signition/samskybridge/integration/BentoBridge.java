...
public class BentoBridge {
  ...
  private static Method mGetOwner;
  private static Method mGetMembers;
  ...
  private static boolean init(){
    try{
      ...
      try{ mGetOwner = clazzIsland.getMethod("getOwner"); }catch(Exception ignore){}
      try{ mGetMembers = clazzIsland.getMethod("getMembers"); }catch(Exception ignore){}
  ...
  public static boolean hasIsland(Player p){ return getIsland(p) != null; }
  public static java.util.UUID getIslandOwner(Player p){
    try{
      Object is = getIsland(p); if (is==null || mGetOwner==null) return null;
      Object uuid = mGetOwner.invoke(is); return (java.util.UUID) uuid;
    }catch(Exception e){ return null; }
  }
  @SuppressWarnings("unchecked")
  public static java.util.Set<java.util.UUID> getMembers(Player p){
    try{
      Object is = getIsland(p); if (is==null || mGetMembers==null) return java.util.Collections.emptySet();
      java.util.Map<java.util.UUID,Integer> m = (java.util.Map<java.util.UUID,Integer>) mGetMembers.invoke(is);

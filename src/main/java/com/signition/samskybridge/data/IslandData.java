...
public class IslandData {
    ...
    public java.util.UUID getOwner() {
        try { return this.ownerUuid; } catch (Throwable t) { return null; }
    }

    public String getOwnerName() {
        java.util.UUID id = null;
        try { id = this.getOwner(); } catch (Throwable ignore) {}
    ...
    public java.util.List<String> getMemberNames() {
        java.util.List<java.util.UUID> src = null;
        try { src = this.members; } catch (Throwable ignore) {}
